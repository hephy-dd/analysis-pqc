...
class PQC_resultset:
    ...
    def __init__(self, batchname, dataseries=None):
        ...
        self.dataseries['vdp_bulk_rho_old'] = PQC_Values("vdpBulk_rho_old", "Bulk VdP Resistivity (1.218)", 3.5, "kOhm*cm (1.218)", 1., minAllowed=3.5, maxAllowed=10.)
        self.dataseries['vdp_bulk_rho'] = PQC_Values("vdpBulk_rho", "Bulk VdP Resistivity (1.081)", 3.5, "kOhm*cm (1.081)", 1., minAllowed=3.5, maxAllowed=10.)
    ...
    def analysisFolder(self, basedir=None):
        return os.path.join(basedir, f"{self.OUTPUT_PREFIX}{self.batch}")
